...
const uploadKidFile = async (req, res) => {
    const { nombre, kid_id } = req.body; // ID del niño relacionado con el archivo subido
    ...
    try {
        ...
        await promisePool.query("INSERT INTO documentos_niños (nombre,url,fecha_subida,id_niño) VALUES (?,?,?,?)", [nombre, file_url, fecha_subida, kid_id]);
